...
pkgdatadir = $(datadir)/imex-sflow2d
pkgincludedir = $(includedir)/imex-sflow2d
pkglibdir = $(libdir)/imex-sflow2d
pkglibexecdir = $(libexecdir)/imex-sflow2d
...
PACKAGE_BUGREPORT = mattia.demichielivitturi@ingv.it
PACKAGE_NAME = IMEX-SfloW2D
PACKAGE_STRING = IMEX-SfloW2D 0.9
PACKAGE_TARNAME = imex-sflow2d
PACKAGE_URL = 
PACKAGE_VERSION = 0.9
PATH_SEPARATOR = :
SET_MAKE = 
